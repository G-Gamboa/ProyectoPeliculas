...
function fetchDataAsync($total_pages) {
    ...
    for ($page = 1; $page <= $total_pages; $page++) {
        $url = "https://api.themoviedb.org/3/tv/on_the_air?language=es-GT&page=" . $page;
...
file_put_contents('json/datosGeneralesSeries.json', json_encode($output, JSON_UNESCAPED_UNICODE));
