...
<head>
    ...
    <title><?php echo htmlspecialchars($data['name'], ENT_QUOTES, 'UTF-8'); ?></title>
            ...
            <div class="row gx-5 align-items-center justify-content-center">
                ...
                <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center img-header">
                    <img class="img-fluid rounded-3 my-5"
                        ...
                        alt="<?php echo htmlspecialchars($data['name'], ENT_QUOTES, 'UTF-8'); ?>" />
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="col-lg-8">
                    <div class="row gx-5 row-cols-1 row-cols-md-2">
                        ...
                        <div class="col mb-5 h-100">
                            ...
                            <h2 class="h5">
                                <?php echo $data['in_production'] ? "En Emisión" : "Finalizada"; ?>
                            </h2>
                        </div>
                        <div class="col mb-5 mb-md-0 h-100">
                            <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3">
                                <i class="bi bi-person-circle"></i> <b>Creador</b>
                            </div>
                            <h2 class="h5">
                                <?php
                                foreach ($data['created_by'] as $member) {
                                    echo htmlspecialchars($member['name'], ENT_QUOTES, 'UTF-8') . "<br>";
                                }
                                ?>
                            </h2>
                        </div>
                        <?php
                        if (!empty($data['next_episode_to_air']['name'])) {
                            echo "<div class='col h-100'>
                                <div class='feature bg-primary bg-gradient text-white rounded-3 mb-3'>
                                    <i class='bi bi-arrow-right-circle'></i> <b>Próximo Episodio</b>
                                </div>
                                <h2 class='h5'>" . htmlspecialchars($data['next_episode_to_air']['name'], ENT_QUOTES, 'UTF-8') . "</h2>
                            </div>";
                        } else {
                            echo "<div class='col h-100'>
                                <div class='feature bg-primary bg-gradient text-white rounded-3 mb-3'>
                        ...
                        <div class='card h-100 shadow border-0'>
                            ...
                            <div class='card-body p-4'>
                                <a class='text-decoration-none link-dark stretched-link' href='infoDetalladaSeries.php?id=" . $peliSimilar['id'] . "'>
                                    <h5 class='card-title mb-3'>" . htmlspecialchars($peliSimilar['name'], ENT_QUOTES, 'UTF-8') . "</h5>
                                </a>
